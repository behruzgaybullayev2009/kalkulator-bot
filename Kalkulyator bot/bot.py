...
async def start_command(message:Message):
    ...
    try:
        ...
        await message.answer(text="Adminlar bilan bog'lanish:\nTel: +998977970802 , Username: @Shoyiqulov_Asilbek\nTel: +998938544100 , Username:@asilbey_001\nTel: +998939783606 , Username:@me_nurbek")
